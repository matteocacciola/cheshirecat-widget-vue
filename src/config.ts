import { CheshireCatClient, WSClient, HttpClient } from 'cheshirecat-typescript-client'
 ...
 */
export let apiClient: CheshireCatClient

const isSecureProtocol = () => window.location.protocol === 'https:'

export const instantiateApiClient = (host: string, port?: number | null, credential?: string) => {
	apiClient = new CheshireCatClient(
		new WSClient(host, port, credential, isSecureProtocol()),
		new HttpClient(host, port, credential, isSecureProtocol())
	);
}
